...
let m,//הגרלה של מיקום הפצצות
    ...
    v=0,//
    flag,//הצליל של סימון פצצה
    noflag,//הצליל של הורדת סימון הפצצה
...
function preload(){    
  ...
  flag=loadSound("flag.mp4");
  noflag=loadSound("noflag.mp4");
...
function mousePressed(){
  ...
  if((touches.length===1)||keyPressed()==""){//אם המשתמש לחץ
